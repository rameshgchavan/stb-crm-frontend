...
const CustomerSection = ({ acNo }) => {
    ...
    return (
        <FormGroup className="border shadow rounded p-3 mb-3">
            ...
            <Form.Label className="d-block fw-bold">Area: {area ? area : "N/A"}, {address}</Form.Label>
            ...
            <div className="d-sm-flex justify-content-around">
                ...
                <Form.Label className="d-block fw-bold">ID: {vc_Nds_Mac_ID ? vc_Nds_Mac_ID : "N/A"}</Form.Label>
